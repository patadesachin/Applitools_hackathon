...
public class AppTestTask2 {
	...
	public static void setUp(final Eyes eyes) {
		...
		config.setBatch(new BatchInfo("UFG___Hackathon"));
		// config.setTestName("Task-1");
		config.setTestName("Task___2");
	...
	public static void ultraFastTest(final WebDriver webDriver, final Eyes eyes) throws InterruptedException {
		...
		//	Thread.sleep(8000);
			  ...
			  eyes.open(webDriver,"Applitools", "Tast___2", new RectangleSize(800, 600));
		...
		//	 eyes.check("Filter Results", Target.window().fully().withName("Applitools UltraFastGrid | Cross Browser Testing Demo App"));
			 eyes.check("Filter Results", Target.region(By.id("DIV__containerm__65")));
