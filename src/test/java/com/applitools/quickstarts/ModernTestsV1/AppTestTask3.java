package com.applitools.quickstarts.ModernTestsV1;
...
public class AppTestTask3 {
	...
	public static void ultraFastTest(final WebDriver webDriver, final Eyes eyes) throws InterruptedException {
		...
		try {
			...
			webDriver.findElement(By.id("DIV__griditem__212")).click();

			Thread.sleep(8000);
			
			  // Call Open on eyes to initialize a test session 
			  eyes.open(webDriver,"Applitools", "Tast---3", new RectangleSize(800, 600));
		...
		//	 eyes.check("Filter Results", Target.window().fully().withName("Applitools UltraFastGrid | Cross Browser Testing Demo App"));
			 eyes.check("Product Details test", Target.region(By.id("page")));
